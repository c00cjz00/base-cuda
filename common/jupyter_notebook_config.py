...
#  
#           This does *not* generate_container.sh the notebook server more secure by itself.
...
#  Choices: any of ['sha3_384', 'sha224', 'sha3_256', 'sha384', 'sha256', 'md5', 'blake2b', 'sha3_224', 'blake2s', 'sha1', 'sha512', 'sha3_512']
#  Default: 'sha256'
...
## Whether to generate_container.sh kernels available before the process has started.  The
...
#           environmental values to generate_container.sh available to the kernel. (JUPYTER_GATEWAY_ENV_WHITELIST env var)
#  Default: ''
